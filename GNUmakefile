...
info-serial:
	@echo "ERLANG_SERIAL_EMBEDDED_BEAM_DIR = $(ERLANG_SERIAL_EMBEDDED_BEAM_DIR)"
	@echo "ERLANG_SERIAL_REBAR_CHECKOUT_BEAM_DIR = $(ERLANG_SERIAL_REBAR_CHECKOUT_BEAM_DIR)"
	@echo "ERLANG_SERIAL_REBAR_BUILD_BEAM_DIR = $(ERLANG_SERIAL_REBAR_BUILD_BEAM_DIR)"
	@echo "ERLANG_SERIAL_USER_BEAM_DIR = $(ERLANG_SERIAL_USER_BEAM_DIR)"
